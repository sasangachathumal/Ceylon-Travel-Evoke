...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image1.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image1.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image3.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image3.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image5.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image5.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image6.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image6.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image9.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image9.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image11.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image11.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image12.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image12.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Tour/image14.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Tour/image14.jpeg" alt="" class="img-responsive">
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            <h3>Colombo - Nuwara Eliya</h3>
                                            <p>On arrival in Sri Lanka, You will be met and assist by Ceylon Travel Evoke
                                                representative and directed to your guide. You will leave Colombo for
                                                coolest area in this small island. You will Transfer to Kadugannawa and
                                                start your Journey by train to Nuwara eliya.</p>
                                            <p>Relax by the Hotel and in night you will reach Gregory Lake in Nuwara
                                                eliya. Have a Boat ride there and enjoy the cool natural environment
                                                with colorful lights.</p>
                                            <p>Overnight stay at Nuwara eliya.</p>
                                        </li>
                                        <li>
                                            <h3>Nuwara Eliya - Horton Plains</h3>
                                            <p>Horton plains otherwise world end is one most Enjoyable Place in Sri
                                                Lanka to Hiking lovers, Horton plains is a beautiful ,stark world with
                                                excellent Hikes in the Shadows of Sri Lanka’s second and third highest
                                                mountains. The diversity of the landscape is matched by the wide variety
                                                of wildlife, although many of the larger animals are very elusive. The
                                                “plins” from an undulating plateau over 2000m high, covered by wild
                                                grasslands and interspersed with patches of thick forest misty lakes,
                                                rocky outcrops and thick forest.</p>
                                            <p>You will Transfer to Kandy and you will visit the old royal city of
                                                kandy,magical and glamourous natural environment and beautifully nestled
                                                between green hills.Sri lankan people admire the temple of the tooth
                                                relic as the blessing of the country.then you will visit that adorable
                                                place which is the holiest shrine in Sri Lanka, where the tooth relic of
                                                lord buddha is highly venerated</p>
                                            <p>In the everything period you will have more opportunity to see dance
                                                performances, where you will see famous kandyan dances, as well as
                                                up-country and devil dances.</p>
                                            <p>Over-night stay in Kandy</p>
                                        </li>
                                        <li>
                                            <h3>Kandy - Sigiriya - Colombo</h3>
                                            <p>Have Breakfast at hotel and leave Kandy to Sigiriya. You will reach the
                                                Sigiriya rock. This impressive monolith which rises 200 meters out of
                                                the jungle has been transferred in 5th century by king Kashyapa into a
                                                fortress and become his capital. Here you will see the frescoes of the
                                                Sigiriya maidens.</p>
                                            <p>After visit Sigiriya you will transfer to Colombo international airport
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/pMwQg7TjPrA2"><i
                                                            class="fa fa-check"></i>Colombo</a></li>
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/YagqkxFNPxQ2"><i
                                                            class="fa fa-check"></i>Nuwara Eliya</a></li>
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/PZGhFrFm7PJ2"><i
                                                            class="fa fa-check"></i>Horton Plains</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/7QaDaMYMbWx"><i
                                                            class="fa fa-check"></i>Kandy</a></li>
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/hAgKdBjySjD2"><i
