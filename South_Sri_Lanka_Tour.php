...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image1.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image1.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image2.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image2.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image3.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image3.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image4.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image4.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image5.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image5.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image6.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image6.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/South_Sri_Lanka_Tour/image7.jpeg" class="fancybox" rel="gallery"></a>
                </div>
                <img src="img/South_Sri_Lanka_Tour/image7.jpeg" alt="" class="img-responsive">
            </div>
        </div>
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by Ceylon Travel
                                                Evoke
                                                representative and directed to your guide. You will Transfer to
                                                Hikkaduwa to check-in to hotel at Hikkaduwa.</p>
                                        </li>
                                        <li>
                                            <h3>Day 02 (Hikkaduwa - Koggala)</h3>
                                            <p>You will have Breakfast at the hotel.</p>
                                            <p>
                                                Transfer to Galle, the capital of the southern province is a city with a
                                                colorful history. UNESCO declared world heritage site the magnificent
                                                Dutch fort is the most popular attraction of the town.
                                                You will visit Galle fort and in the evening period travel to Jungle
                                                beach and relax in the beach.</p>
                                        </li>
                                        <li>
                                            <h3>Day 03 (Koggala)</h3>
                                            <p>Breakfast at the hotel</p>
                                            <p>Koggala Lake is an un-spoiled lake located in Southern province. It will
                                                feel like a paradise for natural lovers, The Lake is embellished with
                                                rocky islands, animals and shrubs. You can explore whole the area and
                                                all the islands. It is quite tremendous for bird watching and sunset
                                                sceneries in the evening</p>
                                            <p>Boat ride in koggala.</p>
                                        </li>
                                        <li>
                                            <h3>Day 04 (Koggala - Kanneliya)</h3>
                                            <p>Breakfast at the hotel</p>
                                            <p>In the morning you will travel to Kanneliya Overnight stay at Galle.
                                            </p>
                                        </li>
                                        <li>
                                            <h3>Day 05 (Galle - Bentota)</h3>
                                            <p>Breakfast at the hotel</p>
                                            <p>You will leave Galle in morning and transfer to Bentota. Relax the day by
                                                beach and hotel.</p>
                                        </li>
                                        <li>
                                            <h3>Day 06 (Bentota - Balapitiya - Bentota)</h3>
                                            <p>After have the breakfast you will travel to balapitiya, You will have an
                                                enjoyable boat safari on Madu river, If you are interesting Fish massage
                                                also available from there.</p>
                                        </li>
                                        <li>
                                            <h3>Day 07 (Bentota - Colombo)</h3>
                                            <p>Breakfast at the hotel and check out.</p>
                                            <p>You will travel to Colombo international airport in the morning
                                                period.</p>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank" href="https://www.google.lk/maps/place/Hikkaduwa/@6.1277317,80.101522,14z/data=!3m1!4b1!4m5!3m4!1s0x3ae177fbcae7226d:0x373eeb50aad15308!8m2!3d6.1394676!4d80.1062861?hl=en"><i
                                                            class="fa fa-check"></i>Hikkaduwa</a></li>
                                                <li>
                                                    <a target="_blank" href="https://www.google.lk/maps/place/Koggala/@6.0026938,80.3139207,14z/data=!3m1!4b1!4m5!3m4!1s0x3ae16ccc65d32a85:0x47fdbb4441fdf8bf!8m2!3d6.000704!4d80.3352364?hl=en"><i
                                                            class="fa fa-check"></i>Koggala</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li><a target="_blank" href="https://www.google.lk/maps/search/Kanneliya/@6.2472843,80.3448477,15.5z?hl=en"><i class="fa fa-check"></i>Kanneliya</a></li>
                                                <li>
                                                    <a target="_blank" href="https://www.google.lk/maps/place/Bentota/@6.425699,79.9861482,14z/data=!3m1!4b1!4m5!3m4!1s0x3ae22e900168ca21:0x96c438f00a68c060!8m2!3d6.4189175!4d80.005979?hl=en"><i
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank" href="https://www.google.lk/maps/place/Balapitiya/@6.2779305,80.0288341,14z/data=!3m1!4b1!4m5!3m4!1s0x3ae180f06ea9bb1b:0x561e2543dfa329a5!8m2!3d6.2753892!4d80.0479039?hl=en"><i
