                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank" href="https://goo.gl/maps/UYqndbFaHuK2"><i
                                                            class="fa fa-check"></i>Hikkaduwa</a></li>
                                                <li>
                                                    <a target="_blank" href="https://goo.gl/maps/hn8ytKQV3632"><i
                                                            class="fa fa-check"></i>Koggala</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li><a target="_blank" href="https://goo.gl/maps/hKyJeBC4vyz"><i class="fa fa-check"></i>Kanneliya</a></li>
                                                <li>
                                                    <a target="_blank" href="https://goo.gl/maps/o9W4U7FDWDG2"><i
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank" href="https://goo.gl/maps/G6SbE12W4uR2"><i
