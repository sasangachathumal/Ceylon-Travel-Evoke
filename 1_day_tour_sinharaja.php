...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image1.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image1.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image2.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image2.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image3.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image3.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4.jpeg" alt="" class="img-responsive">
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="pull-right">
                                    <a href="bookTour.php?tour=1 Day Tour - Sinharaja&type=1day"><i
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by Ceylon Travel
                                                ...
                                                Rathnapura visit Gem museum and Gem mining industry in Rathnapuara and
                                                Bopath ella.</p>
                                            <p>Next will Transfer to Sinharaja forest.</p>
                                            <p>Sinharaja nature reserve for a day of bird watching and trekking through
                                                ...
                                                Lanka.</p>
                                            <p>Then you will travel to bentota..Relax By the beach or Hotel.End of the
                                                day you will drop off at Colombo.</p>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/ufxnZteLNvG2"><i
