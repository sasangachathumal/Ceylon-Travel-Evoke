...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4sigiriya%20(1).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4sigiriya%20(1).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4sigiriya%20(2).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4sigiriya%20(2).jpeg" alt="" class="img-responsive">
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            <h3>1 day tour to Sigiriya</h3>
                                            <p>Arrival in Colombo international Airport and meet with our
                                                representative, You leave Colombo in the morning and drive along
                                                highways into the middle area of country.The nature and calm environment
                                            ...
                                            <p>Then You will transfer to Sigiriya and have lunch at there.You will climb
                                                sigiriya rock after having Lunch.You will have the chance to elephant
                                                back ride too.</p>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/baKdD7KTEf32"><i
                                                            class="fa fa-check"></i>Sigiriya</a></li>
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/QymuEJSTJfF2"><i
                                                            class="fa fa-check"></i>Pinnewela</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
