                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/hotel_list/South_Sri_Lanka_Tour.png" alt="" class="img-responsive">
                                    <!--<div class="overlay"><a href="img/hotel-img/1.jpg" class="fancybox"><i-->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/hotel_list/Hiking_Sri_Lanka.png" alt="" class="img-responsive">
                                </div>
                                <div class="info-gallery">
                                    <h3>
                                        Hiking in Sri Lanka<br>
                                    </h3>
                                    <hr class="separator">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/1_day_tours.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="info-gallery">
                                    <h3>
                                        1 Day Tours<br>
                                    ...
                                    <hr class="separator">
                                    <p>You can travel to Kandy, Sigiriya, Yala, Sinharaja, Maadu River.</p>
                                    <br><hr class="separator">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/hotel_list/7_days_(Honeymoon).png" alt="" class="img-responsive">
                                </div>
                                <div class="info-gallery">
                                    <h3>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/hotel_list/2_nights_and_3_days.png" alt="" class="img-responsive">
                                </div>
                                <div class="info-gallery">
                                    <h3>
                                        3 Day Tour<br>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="img-hover">
                                    <img src="img/hotel_list/3_nights_and_4_days.png" alt="" class="img-responsive">
                                </div>
                                <div class="info-gallery">
                                    <h3>
                                        4 Day Tour<br>
