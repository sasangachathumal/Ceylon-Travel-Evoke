...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image1madu%20(1).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image1madu%20(1).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image1madu%20(2).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image1madu%20(2).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image1madu%20(3).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image1madu%20(3).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image1madu%20(4).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image1madu%20(4).jpeg" alt="" class="img-responsive">
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="pull-right">
                                    <a href="bookTour.php?tour=1 Day Tour - Maadu River&type=1day"><i
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            <h3>1 day tour to Maadu river boat safari</h3>
                                            <p>Arrival in Colombo international Airport and meet with our
                                                representative,You will Transfer Hikkaduwa and Breakfast at hotel and
                                                check-out Hotel.You will drive to Balapitiya which is one nice natural
                                                area in southern province.You will have an enjoyable boat safari on Madu
                                                river,If you are interesting Fish massage also available from there.</p>
                                            <p>In afternoon you transfer to Galle and Visit the Galle fort. Galle fort
                                                is a one of most attractive Place in Southern Sri Lanka.</p>
                                            <p>Relax by the beach or Hotel.End of the tour you will drop off at
                                                Colombo.</p>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/cPHkwuD87q32"><i
                                                            class="fa fa-check"></i>Maadu river</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
