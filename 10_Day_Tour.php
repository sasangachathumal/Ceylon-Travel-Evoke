                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="pull-right">
                                    <a href="bookTour.php?tour=10 Day Tour Package&type=10day"><i class="fa fa-bookmark"></i>Reserve this Tour</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                ...
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/rMWNhqMnnCQ2"><i
                                                            class="fa fa-check"></i>Tangalle</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list-styles">
