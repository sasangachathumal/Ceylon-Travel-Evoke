...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/3_Nights_4_days/12.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/3_Nights_4_days/12.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/3_Nights_4_days/13.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/3_Nights_4_days/13.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/3_Nights_4_days/14.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/3_Nights_4_days/14.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/3_Nights_4_days/15.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/3_Nights_4_days/15.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/3_Nights_4_days/16.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/3_Nights_4_days/16.jpeg" alt="" class="img-responsive">
            </div>
        </div>
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by our representative and directed to your guide. You will Transfer to Hikkaduwa</p>
                                            <P>Check into hotel at Hikkaduwa</P>
                                            <p>Relax by the beach</p>
                                        </li>
                                        <li>
                                            <h3>Day 02 (Galle - Jungle beach - Rumassala)</h3>
                                            ...
                                            <p>You will visit Galle fort and in the evening period travel to Jungle beach and have a enjoyable bath and visit Rumassala,</p>
                                            <p>Overnight stay at Galle</p>
                                        </li>
                                        <li>
                                            <h3>Day 03 ( Mirissa - Koggala - Bentota)</h3>
                                            <p>Have Breakfast at hotel and check out hotel. Start the journey to bentota in the morning visit Mirissa Area and drive to koggala. You will have boat ride in Koggala Lake</p>
                                            <p>Koggala Lake is an un-spoiled lake located in Southern province. It will feel like a paradise for natural lovers, The Lake is embellished with rocky islands, animals and shrubs. You can explore whole the area and all the islands. It is quite tremendous for bird watching and sunset sceneries in the morning.</p>
                                            <p>In afternoon Move to Bentota and relax by the beach.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <ul class="list-styles">
                                                ...
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/ZkMJZnPPxq52"><i
                                        ...
                                        <div class="col-md-3">
                                            <ul class="list-styles">
                                                ...
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/mWNmyAByvVs"><i
                                                            class="fa fa-check"></i>Jungle beach</a></li>
                                                <li>
                                                    <a target="_blank"
                                        ...
                                        <div class="col-md-3">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/VNEsKV2asem"><i
                                                            class="fa fa-check"></i>Rumassala</a></li>
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/LEBTs4aSrPQ2"><i
                                                            class="fa fa-check"></i>Mirissa</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
