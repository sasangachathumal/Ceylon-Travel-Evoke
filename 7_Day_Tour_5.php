                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="pull-right">
                                    <a href="bookTour.php?tour=7 Day Tour Package 5&type=honeymoon"><i class="fa fa-bookmark"></i>Reserve this Tour</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        ...
                                        <li>
                                            <h3>Day 03 (Maadu river - Bentota)</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/RNShWWFRDYB2"><i
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/Bn3tQAeva3q"><i
