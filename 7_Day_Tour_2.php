...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/7-day-tours/image3.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/7-day-tours/image3.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/7-day-tours/image2%20(3).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/7-day-tours/image2%20(3).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/7-day-tours/image4%20(3).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/7-day-tours/image4%20(3).jpeg" alt="" class="img-responsive">
            </div>
        </div>
                                ...
                                <div class="tab-pane active" id="plan">
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by Tour star representative and directed to your guide.Colombo the capital of Sri Lanka, has a long history as a port on ancient east-west trade routes, ruled successively by the Portuguese, Dutch and British. At the evening period is at leisure with dinner and overnight stay at the Hotel.</p>
                                            <p>Candle Light Dinner.</p>
                                        </li>
                                        <li>
                                            <h3>Day 02 (Colombo - Kandy)</h3>
                                            <p>Breakfast at the Hotel and check out.You leave Colombo in the morning and travel to Kandy witnessing the change of scenery and climate. Arrive and check-in at hotel.</p>
                                            <p>Evening,you will visit the old royal city of kandy,magical and glamourous natural environment and beautifully nestled between green hills.Sri lankan people admire  the temple of  the  tooth relic as the blessing of the country.then you will visit that adorable place which is the holiest  shrine in Sri Lanka, where the tooth relic of lord buddha is highly venerated.As well you will have more opportunity to witness cultural dance performances, where you will see famous kandyan dances, as well as up-country and devil dances.</p>
                                            <p>Return to the Hotel for dinner and over night stay.</p>
                                        </li>
                                        <li>
                                            <h3>Day 03 (Kandy - Peradeniya)</h3>
                                            <P>After Breakfast at Hotel, commence a sightseeing tour of Kandy city including Gem museum, Art and craf centre and Bazar.(if you are interesting to visit this beautiful town by riding scooty, you will give the facility for that too)</P>
                                            <p>You visit the world famous botanical garden in peradeniya.As Sri Lanka’s largest garden an elegent and spacious 147-acres (60-hectares) plent of time is  needed to stroll peradeniya’s imposing avenue of Royal palms.The park dates back to 1371 under the reign of king Vikramabahu III when he held court here.</p>
                                            <p>Candle light Dinner and overnight stay at the hotel in Peradeniya.</p>
                                        </li>
                                        <li>
                                            <h3>Day 04 (Peradeniya - Nuwara eliya)</h3>
                                            <p>Breakfast at the hotel and check-out.Travel to Nuwara eliya en route visiting a tea plantation and a factory.Arrive and visit the city before check-in at hotel for dinner and over night stay.</p>
                                        </li>
                                        <li>
                                            <h3>Day 05 (Nuwara eliya - Ella)</h3>
                                            <p>After have Breakfast at the hotel and check out. Travel to Nanu oya to take an enjoyable train journey to Ella.</p>
                                            <p>Arrive and check in at the hotel for rest Dinner and over night stay at the hotel.</p>
                                        </li>
                                        <li>
                                            <h3>Day 06 (Ella)</h3>
                                            <p>Ella is blessed with some of the most beautiful veiws you could enjoy in Sri Lanka.some of the places you could see in Ella are the Ella Gap, Rawna Ella Falls, Little Adams’peak among the other many varied pleasant walks with stunning scenery.</p>
                                        </li>
                                        <li>
                                            <h3>Dday 07 (Ella - Colombo)</h3>
                                            <p>Breakfast at hotel and check-out hotel.You will travel to Colombo international airfort for your departure.</p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-pane" id="destinations">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li><a target="_blank"
                                                       href="https://goo.gl/maps/CST1y5mua7v"><i
                                                            class="fa fa-check"></i>Peradeniya</a></li>
                                                <li><a target="_blank"
                                                       href="https://goo.gl/maps/yaf533xQbgF2"><i
