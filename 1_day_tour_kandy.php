...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4kandy%20(1).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4kandy%20(1).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4kandy%20(2).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4kandy%20(2).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4kandy%20(3).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4kandy%20(3).jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/1_day_tours/image4kandy%20(4).jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/1_day_tours/image4kandy%20(4).jpeg" alt="" class="img-responsive">
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="pull-right">
                                    <a href="bookTour.php?tour=1 Day Tour - Kandy&type=1day"><i
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by Ceylon Travel Evoke
                                                ...
                                                ruled successively by the Portuguese, Dutch and British. </p>
                                            <p>After visit capital city of Ceylon you will leave Colombo in and travel
                                                to Kandy witnessing the change of scenery and climate. Arrive and
                                                check-in at hotel.</p>
                                            <p>Evening,you will visit the old royal city of kandy,magical and glamourous
                                                natural environment and beautifully nestled between green hills.Sri
                                                lankan people admire the temple of the tooth relic as the blessing of
                                                the country.then you will visit that adorable place which is the holiest
                                                shrine in Sri Lanka, where the tooth relic of lord buddha is highly
                                                venerated.As well you will have more opportunity to witness cultural
                                                dance performances, where you will see famous kandyan dances, as well as
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/uke5SAyUNMu"><i
