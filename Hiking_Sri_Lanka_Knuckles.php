...
<div id="layout">
    ...
    <div class="section-title-detailed">
        ...
        <div id="single-carousel">
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Knukls/image1.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Knukls/image1.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Knukls/image13.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Knukls/image13.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Knukls/image5.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Knukls/image5.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Knukls/image16.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Knukls/image16.jpeg" alt="" class="img-responsive">
            </div>
            <div class="img-hover">
                <div class="overlay"><a href="img/Hiking_Sri_Lanka_Knukls/image9.jpeg" class="fancybox"
                                        rel="gallery"></a>
                </div>
                <img src="img/Hiking_Sri_Lanka_Knukls/image9.jpeg" alt="" class="img-responsive">
            </div>
        </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p>On arrival in Sri Lanka, You will be met and assist by Ceylon Travel Evoke
                                                ...
                                                nature and calm environment will make you feel awesome.</p>
                                        ...
                                        <li>
                                            ...
                                            <p>Knuckles Mountain range is one of the best places in Sri Lanka, Knuckles
                                                is a collection of 34 mountains ranges which covers part of Kandy and
                                                Mathale districts in central hills.</p>
                                            <p>Early morning you will start the Journey and in there you will visit
                                                several Waterfalls,wild life and beautiful view of Knuckles.</p>
                                            <p>We will travel to there on the way of kandy, watthegama Bambaraella and
                                                return on same way.</p>
                                            <p>Overnight Stay at Kandy.</p>
                                        </li>
                                        <li>
                                            <h3>Kandy - yala</h3>
                                            <p>Breakfast at the hotel and transfer to Yala national park,Yala is an
                                                ideal place to spot the “Big Four” of Sri Lankan wildlife, the
                                                elephants, the sloth bears the illusive leopard and the wild buffalo,
                                                the unsung denizen of the park, if nothing else dangerous to the
                                                extreame .You will drive to Yala Safari camp.</p>
                                            <ul>
                                                <li>Lunch at the camp</li>
                                                <li>Evening game drive</li>
                                                <li>BBQ Dinner and overnight stay at the camp</li>
                                            </ul>
                                            <p>Overnight Stay at Yala</p>
                                        </li>
                                        <li>
                                            <h3>Yala - Colombo</h3>
                                            <p>Have breakfast and Transfer to Colombo International airport with nice
                                                experience.</p>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                ...
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/ujuFCGrJxNu"><i
                                                            class="fa fa-check"></i>Knuckles</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="list-styles">
                                                <li>
                                                    <a target="_blank"
                                                       href="https://goo.gl/maps/Q9AdY9n1w822"><i
                                                            class="fa fa-check"></i>Yala</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
